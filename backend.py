...
def find_leads(req: SearchReq):
    ...
    rows=[{"Score":l.lead_score,"Name":l.name,"Address":l.address,"Phone":l.phone,"Email":l.email or "","Website":l.website or "NONE","Rating":l.rating,"Reviews":l.review_count,"Source":l.source} for l in all_l]
